          ...
          <form onSubmit={() => {setPaymentSection(true); setDeliverySection(false)}}>
            ...
            <div className="grid lg:grid-cols-2 lg:gap-4 gap-2 pb-6">
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                      ...
                      placeholder="First Name"  type="text" id="firstName" name="firstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="Last Name"  type="text" id="lastName" name="lastName" value={lastName} onChange={(e) => setLastName(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="E-mail"  type="email" id="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="Mobile Number"  type="tel" id="mobileNumber" name="mobileNumber" value={mobileNumber} onChange={(e) => setMobileNumber(e.target.value)} />
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4  lg:gap-4 gap-2 pb-6">
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 col-span-2
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="Address"   type="text" id="address" name="address" value={address} onChange={(e) => setAddress(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 col-span-2
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
              ...
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="ZIP/Postal code"  type="text" id="postalCode" name="postalCode" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="Town"  type="text" id="town" name="town" value={town} onChange={(e) => setTown(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px] " 
                      placeholder="District"  type="text" id="district" name="district" value={district} onChange={(e) => setDistrict(e.target.value)} />
              <select className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 
                                 placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px] 
                                 focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]"
                      placeholder="Country"  id="country" name="country" value={country} onChange={(e) => setCountry(e.target.value)}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-3 lg:grid-cols-6  lg:gap-4 gap-2 pb-6">
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 col-span-3
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="Card Number"   type="text" id="cardNumber" name="cardNumber" value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 col-span-3
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="Card Holder"   type="text" id="cardHolder" name="cardHolder" value={cardHolder} onChange={(e) => setCardHolder(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="Month"   type="text" id="expirationMonth" name="expirationMonth" value={expirationMonth} onChange={(e) => setExpirationMonth(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="Year"   type="text" id="expirationYear" name="expirationYear" value={expirationYear} onChange={(e) => setExpirationYear(e.target.value)} />
              <input  className="bg-[#f7f7f7] pl-3 w-full pt-4 pb-3 my-1 text-sm focus:outline-none text-neutral-500 
                                  placeholder:text-[#a7a7a7] placeholder:text-xs placeholder:tracking-wider placeholder:translate-y-[-2px]
                                  focus:placeholder:text-[0.60rem] focus:placeholder:translate-y-[-15px]" 
                      placeholder="CVV"   type="text" id="cvv" name="cvv" value={cvv} onChange={(e) => setCvv(e.target.value)} />
